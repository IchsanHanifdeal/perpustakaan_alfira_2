    ...
    <section class="min-h-screen flex items-stretch">
        <div
            ...
            <div class="w-full px-24 z-10">
                <p class="text-4xl leading-tight tracking-wide font-semibold max-w-lg text-white">Temukan dan kelola
                    koleksi perpustakaan Anda dengan mudah bersama <strong class="text-primary">Perpustakaan</strong>.</p>
            </div>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
            ...
            <div class="w-full py-6 z-20">
                ...
                <form action="{{ route('auth') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto" method="POST">
                    ...
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg text-sm px-5 py-2.5 text-center font-bold text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                        Masuk
                    </button>
                </form>
            </div>
